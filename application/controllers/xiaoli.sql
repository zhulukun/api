...
INSERT INTO `xl_avatar` VALUES ('65d3b46e0a2710ebc24521d40853971a','a5d067602a08a1050b6f9f5b1498737d','http://localhost/api/uploads/1451658533_494.png','png'),('d6cf7fc39ba5ac257c4988a95c76cb7f','f3bec40b5549d7744d33f441be8eafae','http://localhost/api/uploads/1450690236_552.jpeg','jpeg');
...
CREATE TABLE `xl_impresscomment` (
  ...
  PRIMARY KEY (`id`),
  KEY `xl_impresscomment_ibfk_1` (`operator_id`),
  KEY `xl_impresscomment_ibfk_2` (`impress_id`),
...
--
-- Dumping data for table `xl_impresscomment`
--

LOCK TABLES `xl_impresscomment` WRITE;
/*!40000 ALTER TABLE `xl_impresscomment` DISABLE KEYS */;
INSERT INTO `xl_impresscomment` VALUES ('8fe8d07940c21410e5567f7f96254e67','f76cdd92a8ae0dbc23fe8dcb0989acce','7ec4df2c4b3d74c17a64d309f2b1fa85','hello1','2015-12-28 01:46:15'),('da8fc2b6ad751721ab9db8540dc377e7','f76cdd92a8ae0dbc23fe8dcb0989acce','7ec4df2c4b3d74c17a64d309f2b1fa85','hello','2015-12-28 01:45:02');
/*!40000 ALTER TABLE `xl_impresscomment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `xl_impressitem`
--

DROP TABLE IF EXISTS `xl_impressitem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `xl_impressitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `xl_impresssitem_ibfk_1` (`target_id`),
  KEY `xl_impresssitem_ibfk_2` (`operator_id`),
...
--
-- Dumping data for table `xl_impressitem`
--

LOCK TABLES `xl_impressitem` WRITE;
/*!40000 ALTER TABLE `xl_impressitem` DISABLE KEYS */;
INSERT INTO `xl_impressitem` VALUES ('060c7d8571044b065e9ebae477a598c9','a5d067602a08a1050b6f9f5b1498737d','f76cdd92a8ae0dbc23fe8dcb0989acce','[{\"content\":\"hello\",\"impresstype\":\"2\"},{\"content\":\"\\u95f7\\u9a9a\\u513f\",\"impresstype\":3}]','2015-12-27 15:56:43',0,0,0),('7ec4df2c4b3d74c17a64d309f2b1fa85','a5d067602a08a1050b6f9f5b1498737d','f76cdd92a8ae0dbc23fe8dcb0989acce','[{\"content\":\"hello\",\"impresstype\":\"2\"},{\"content\":\"\\u95f7\\u9a9a\\u513f\",\"impresstype\":3}]','2015-12-27 13:46:33',2,1,0),('9282d0739bcd87940db1f15560c6b97f','a5d067602a08a1050b6f9f5b1498737d','f76cdd92a8ae0dbc23fe8dcb0989acce','[{\"content\":\"hello\",\"impresstype\":\"2\"},{\"content\":\"\\u95f7\\u9a9a\\u513f\",\"impresstype\":3}]','2015-12-27 13:43:12',0,0,0),('f44809acebef0953188a43e680893c62','a5d067602a08a1050b6f9f5b1498737d','f76cdd92a8ae0dbc23fe8dcb0989acce','[{\"content\":\"hello\",\"impresstype\":\"2\"},{\"content\":\"\\u95f7\\u9a9a\\u513f\",\"impresstype\":3}]','2015-12-27 15:53:57',0,0,0);
/*!40000 ALTER TABLE `xl_impressitem` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `xl_impressitemref`
--

DROP TABLE IF EXISTS `xl_impressitemref`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `xl_impressitemref` (
  ...
  `impress_id` varchar(128) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `xl_impressitemref_ibfk_1` (`operator_id`),
  KEY `xl_impressitemref_ibfk_2` (`impress_id`),
...
--
-- Dumping data for table `xl_impressitemref`
--

LOCK TABLES `xl_impressitemref` WRITE;
/*!40000 ALTER TABLE `xl_impressitemref` DISABLE KEYS */;
/*!40000 ALTER TABLE `xl_impressitemref` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `xl_plan` (
  ...
  KEY `xl_plan_ibfk_3` (`category_id`),
  CONSTRAINT `xl_plan_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `xl_account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `xl_plan_ibfk_3` FOREIGN KEY (`category_id`) REFERENCES `xl_plantype` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `xl_plan` VALUES ('2b49ae122541ec9f318d1214844a6ccd','如何打造职场人脉关系','<p>打造职场人脉关系</p>',1,'created','2016-01-06 07:23:00','f3bec40b5549d7744d33f441be8eafae','fadf',0,0),('57f5da3cf81ddd721a1032ac4648ba97','如何打造职场人脉关系','<p>打造职场人脉关系</p>',1,'created','2016-01-06 07:22:45','f3bec40b5549d7744d33f441be8eafae','fadf',0,0),('79fbca33f2fad26856768b5ad5e5b89c','如何打造职场人脉关系','<p>打造职场人脉关系</p>',1,'created','2016-01-06 07:22:47','f3bec40b5549d7744d33f441be8eafae','fadf',0,0),('aaa','','',0,'created','2015-12-03 16:32:44','15ecfff668f79342661e7520cbefb86d',NULL,0,0),('cc2985ab76fb556d7269a61db3050f01','hello','<p>ddddd</p>',1,'created','2016-01-06 09:40:00','f3bec40b5549d7744d33f441be8eafae','fadf',0,0),('d28d26d11afe735d5d1dd05a26781bd1','新年礼物方案','<p>hello world<br/></p>',1,'created','2016-01-10 12:02:29','afda','http://localhost/api/uploads/1452427231_916.png',0,0),('de8d580814143df43b07bf73f3e66883','ddd','<p>ccccc</p>',1,'created','2016-01-06 07:16:09','f3bec40b5549d7744d33f441be8eafae','fadf',0,0),('e44c2debc9549340d54de991c34c4806','如何打造职场人脉关系网络','<p>打造职场社交</p>',4,'created','2016-01-06 07:21:11','f3bec40b5549d7744d33f441be8eafae','fadf',0,0);
...
INSERT INTO `xl_plantype` VALUES (1,'童装','baby1','童装分类'),(2,'女装','women11','女装类别'),(3,'礼物','gift','礼物社交'),(4,'笔记本','notebook','打折笔记本'),(5,'幻灯片','ppt','这是首页幻灯片位置'),(6,'ddd','ddd','aaa');
...
CREATE TABLE `xl_planreflabel` (
  `id` varchar(128) NOT NULL,
  `plan_id` varchar(128) NOT NULL,
  `label` varchar(128) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `plan_id` (`plan_id`),
  CONSTRAINT `xl_planreflabel_ibfk_1` FOREIGN KEY (`plan_id`) REFERENCES `xl_plan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
